...
namespace API.Data.Migrations
{
    ...
    [Migration("20221019134524_IdentityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.MemberLike", b =>
                {
                    ...
                    b.Property<int>("LikedMemberId")
                        .HasColumnType("INTEGER");

                    b.HasKey("SourceMemberId", "LikedMemberId");

                    b.HasIndex("LikedMemberId");

                    b.ToTable("Likes");
                });

            modelBuilder.Entity("API.Entities.MemberRole", b =>
                {
            ...
            modelBuilder.Entity("API.Entities.Photo", b =>
                {
                    b.HasOne("API.Entities.Member", "AppUser")
                        .WithMany("Photos")
